# Provide Current Weather Readings

## Metadata

- **Name**: Provide Current Weather Readings
- **Type**: Capability
- **System**: weather
- **Component**: weather-sensor-driver
- **ID**: CAP-396729
- **Approval**: Approved
- **Owner**: Product Team
...
## Technical Overview
### Purpose
Provides current Weather Sensor Readings. Provides current temperature, wind speed, wind direction, precipitation rate, pressure and sky condition.
...
|---------------|-------------|
| CAP-338573 | Adheres to quality standards |
